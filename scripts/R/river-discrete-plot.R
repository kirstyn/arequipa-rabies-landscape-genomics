...
# 1. Load data
# -----------------------------
river_summary <- read.csv("analysis/BEAST_runs/discrete-trait-runs/river-areas/merged_summary_with_avg_jumps.csv")
#river_summary <- read.csv("analysis/BEAST_runs/discrete-trait-runs/river-areas/river-downsampled/downsampled_river_merged_summary_with_avg_jumps.csv")

tree <- read.beast("analysis/BEAST_runs/discrete-trait-runs/river-areas/n148-discrete-river.hipst.tre")
#tree <- read.beast("analysis/BEAST_runs/discrete-trait-runs/river-areas/river-downsampled/n148_treemmer_pruned_1_river.hipstr.tre")
...
chili_river <- readRDS("processed_data/gis_data/chili_river.rds")
river_map <- ggplot() +
...
# -----------------------------
ggsave(
  filename = "results/figures/river-discrete.pdf",
  plot = combined_plot,
