# ==============================================================================
# Title: create_croplands_resistance_layers.R
# Description: Create croplands land cover (from esri) resistance layer for landscape analyses
...
# 0. LOAD DATA
# -------------------------
r <- rast(here("raw_data","spatial","shapefiles", "esri","19K_20240101-20241231.tif"))
...
r_align <- terra::resample(r_crop, base_raster, method = "near")
