...
mcc_tre <- readAnnotatedNexus(
  "analysis/BEAST_runs/continuous-trait-runs/n166/n166-rrw-ucld-constant.hipstr.tre"
)

mostRecentSamplingDatum <- 2025.18

mcc_tab <- read.csv(
  "analysis/BEAST_runs/continuous-trait-runs/n166/n166-rrw-ucld-constant.hipstr.csv"
)

# =========================
# GLOBAL TIME RANGE (CRITICAL FIX)
# =========================
minYear <- floor(min(c(mcc_tab$startYear, mcc_tab$endYear)))
maxYear <- ceiling(max(c(mcc_tab$startYear, mcc_tab$endYear)))

# If you KNOW data starts at 2013, uncomment:
# minYear <- 2013

# =========================
# COLOUR SCALE (BLUE → YELLOW, LATAM CONSISTENT)
# =========================
...
# =========================
# UNIVERSAL TIME → COLOUR FUNCTION
# =========================
...
# OUTPUT MAP
# =========================
png("results/figures/n166-beast-map.png",
    width = 180, height = 140, units = "mm", res = 600)

cairo_pdf("results/figures/n166-rrw-beast-map.pdf",
          width = 180/25.4,
          height = 140/25.4)
...
cairo_pdf("results/figures/timescale_horizontal.pdf",
