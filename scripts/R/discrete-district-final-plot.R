...
# 1. Load data
# -----------------------------
district_summary <- read.csv("analysis/BEAST_runs/discrete-trait-runs/district/district_summary.csv")
...
combined_plot
ggsave(
  filename = "results/figures/district-discrete-mappedJumps-BFover50.pdf",
  plot = combined_plot,
  width = 6,
  height = 5,
  dpi = 600
...
ggsave(
  filename = "results/figures/district-discrete-mappedJumps-BFover50-rewardlegend.pdf",
  plot = reward_legend,
  width = 6, height = 5, dpi = 600
)

ggsave(
  filename = "results/figures/district-discrete-mappedJumps-BFover50-combinedlegend.pdf",
  plot = combined_legend,
  width = 4, height = 4.5, dpi = 600
)

ggsave(
  filename = "results/figures/district-discrete-mappedJumps-BFover50-fulllegend.pdf",
  plot = big.legend,
