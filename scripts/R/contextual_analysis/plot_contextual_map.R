...
# Description: Spatial map to highlight countries with Am5 subclade circulating (and the broader scope of rabv in lac)
...
annot=read.table(here("analysis","contextual_analysis","la_tree_apr82026","La_complete_metadata.txt"), sep="\t", header=T)
...
### LAC map - all the countries that have RABV seq data (regardless of clade)
