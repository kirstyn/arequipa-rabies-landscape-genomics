# ==============================================================================
# Title: n166_beast_tree.R
# Description: Plot hipstr tree from beast analysis of n166 peru seq
...
tree_file <- here("analysis","BEAST_runs","no-trait","n166","n166-ucld-constant.hipstr.tre")
...
# -----------------------------
meta_file <- here("processed_data","processed_metadata","081025_epi-seq_n167_beast_annot2.txt")
...
# -----------------------------
ggsave(
  filename = here("figures","n166_hipstr_tree_half_A4_fullwidth.pdf"),  
  plot = p2,
...
ggsave(
  filename = here("figures","n166_hipstr_tree_half_A4_fullwidth.png"),
  plot = p2,
  width = 21,
  height = 20,
  units = "cm",
...
# -----------------------------
rivers <- st_read(
  here("raw_data","spatial","shapefiles","peru-260528-free.shp","gis_osm_waterways_free_1.shp")
) %>%
  st_transform(4326)
...
ggsave(
  filename = here("figures","arequipa_rabies_map.png"),
  plot = last_plot(),
  width = 180,
  height = 140,
  units = "mm",
...
ggsave(
  filename = here("figures","arequipa_rabies_map.pdf"),
  plot = last_plot(),
  width = 180,
  height = 140,
  units = "mm",
...
figure_plot <- (arequipa_rabies_map+p2) +
...
# ggsave(
#   filename = here("figures","n166tree-map.pdf"),  # PDF for vector quality
#   plot = figure_plot ,
#   width = 21,      # full A4 width in cm
...
# # Optional: PNG raster version
# ggsave(
#   filename = here("figures","n166tree-map.png"),
#   plot = figure_plot ,
#   width = 21,
#   height = 30,
#   units = "cm",
