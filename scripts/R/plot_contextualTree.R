...
#tree=read.newick("analysis/contextual_analysis/la_no_bats/LA_with_no_bat_and_outgroup_gtr_model_outlierBranchesRemoved.treefile")
#tree=read.newick("analysis/contextual_analysis/la_no_bats/feb192026/LA_with_no_bat_and_outgroup_gtr_modelinternalandoutlierBranchesRemoved.treefile")
tree=read.newick("analysis/contextual_analysis/lac-all/la_tree_apr82026/redcap_plus_la_plus_outgroup_stripped_outlierBranchesRemoved.treefile")

## metadata
source("scripts/R/plot_contextual_map.R")

#annot=read.table("analysis/contextual_analysis/la_no_bats/metadata_withArequipa.tsv", header=T, sep="\t")
...
ggsave(
  filename = "results/figures/LAC_tree_country.tiff",
  plot = country_plot,
  device = "tiff",
  dpi = 600,
  width = 180,
...
ggsave(
  filename = "results/figures/LAC_tree_country.pdf",
  plot = country_plot,
  device = cairo_pdf,
  width = 180,
  height = 220,
...
# tree with clade coloured 
 clade_plot <-  gplot+
  ...
  ggsave(
    filename = "results/figures/LAC_tree_minorClade.tiff",
    plot = clade_plot,
    device = "tiff",
    dpi = 600,
    width = 180,
  ...
  ggsave(
    filename = "results/figures/LAC_tree_minorClade.pdf",
    plot = clade_plot,
    device = cairo_pdf,
    width = 180,
    height = 220,
