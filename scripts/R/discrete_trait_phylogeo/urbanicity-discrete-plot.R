# ==============================================================================
# Title: urbanicity-discrete-plot.R
# Description: Summarise and plot urbanicity as discrete trait analyses from beast
...
# 1. Load data
# -----------------------------
area_summary <- read.csv(here("analysis","BEAST_runs","discrete-trait-runs","urban-periurban","area_merged_summary_with_avg_jumps.csv"))
area_tree <- read.beast(here("analysis","BEAST_runs","discrete-trait-runs","urban-periurban","n148-discrete-area.area.history.hipstr.tre"))
...
# ggsave(
#   filename = here("figures","area-discrete.pdf"), 
#   plot = combined_plot,
