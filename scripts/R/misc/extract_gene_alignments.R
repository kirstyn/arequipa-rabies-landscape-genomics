...
#input file
file=here("processed_data","nt_alignments","redcap_download_20251009_arequipa_only_mainIntro_n148.renamed_nextalign","redcap_download_20251009_arequipa_only_mainIntro_n147.renamed.nextalign.aligned.beast.fasta")
